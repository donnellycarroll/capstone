class RsvpsController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to rsvps_path, status: :see_other, notice: "Rsvp was successfully destroyed." }
  ...
  private
    ...
    def set_rsvp
      @rsvp = Rsvp.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def rsvp_params
      params.expect(rsvp: [ :attendee_id, :event_id ])
    end
end
